...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and league matches for soccer players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice drills, scrimmages, and interschool basketball competitions",
    ...
    "Drama Club": {
        "description": "Acting, stage production, and theater rehearsals",
